...
class GeeGrow_SSD1306_128_32 {
	...
	protected:
		...
		params_t params;
		int8_t encoding;
		GeeGrow_SSD1306_libNumbersAscii *libNumbersAscii = NULL;
		GeeGrow_SSD1306_libLettersAscii *libLettersAscii = NULL;
		GeeGrow_SSD1306_libSymbolsAscii *libSymbolsAscii = NULL;
		GeeGrow_SSD1306_libLettersCyrillic *libLettersCyrillic = NULL;
